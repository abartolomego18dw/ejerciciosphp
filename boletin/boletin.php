...
<body>
  ...
  <form action="mostrardatos.php"  method="post">
    ...
    <div id="interes">
      ...
      <input type="checkbox" name="lenguaje[]" value="Phyton"/> Phyton<br>
      <input type="checkbox" name="lenguaje[]" value="Java"/> Java<br>
      <input type="checkbox" name="lenguaje[]" value="PHP"/> PHP<br>
      <input type="checkbox" name="lenguaje[]" value="Javascript"/> Javascript<br>
      <input type="checkbox" name="lenguaje[]" value="Ruby"/> Ruby<br>
      <input type="checkbox" name="lenguaje[]" value="C#"/> C#<br><br>
    </div>
    <div id="dia">
